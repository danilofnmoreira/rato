        ...
        IProfile
{
    ...
    private void retrieveProfileImage(){
        ...
        int avatar = 0;
        try{
            avatar = Integer.parseInt(((com.danilove.rato.UserClient)getApplicationContext()).getUser().getAvatar());
    ...
    public void onImageSelected(int resource) {
        ...
        User user = ((com.danilove.rato.UserClient)getApplicationContext()).getUser();
